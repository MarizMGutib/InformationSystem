                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60">
                  ...
                  >
                    ...
                    <div className="px-[2rem] mt-[2rem]">
                      ...
                      <input
                        type="email"
                        className="border py-2 mt-2 w-full border-[#C8C8C8] rounded-[5px] outline-none placeholder:text-gray-500 placeholder:px-[1rem]"
              ...
              {isAllDoneModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60">
                  ...
                  >
                    ...
                    <p className="flex items-center justify-center pt-[1rem]">Continue as Niknik123?</p>
                    <div className="w-full mt-4 px-[2rem]">
                      <button
                        className="bg-[#24968B] w-full text-white py-2 rounded-[5px]"
                        onClick={closeModal}
