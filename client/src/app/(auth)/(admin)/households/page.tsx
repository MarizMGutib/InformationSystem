...
const Households = () => {
  ...
  useEffect(() => {
    // Check the current route and set the selected card accordingly
    const activeCardIndex = cards.findIndex(card => card.link === pathname);
    setSelectedCard(activeCardIndex);
  }, [pathname]);
